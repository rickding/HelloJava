...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperEntityClass("com.hello.entity.BaseEntity");

        strategy.setSuperControllerClass("com.hello.controller.BaseController");
